window.addEventListener("load", function () {
  ...
  //preguntamos si el carro se enceuntra vacio
  if (str != null && str != "") {
    ...
    alert.innerHTML = "There not product in your car";
    const card = document.createElement("div");
    card.setAttribute("class", "card");
    container.appendChild(card);
  ...
  let checkout = document.querySelector(".prueba");
  //////// GUARDAMOS LOCALSTORAGE EN UN INPUT ///////////
  checkout.addEventListener("click", function (e) {
    let local = document.querySelector(".inputLocal");
    local.setAttribute("value", localStorage.getItem("datos"));
  });
});
